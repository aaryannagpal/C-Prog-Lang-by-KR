/*Take input of lines, print the length of the longest line, as well as the longest line*/
...
int main(){
    ...
    if (max > 0){ //meaning line even existed
        printf("%d is the length (including the new line character) of the longest line, %s", max, longest);
    }
    return 0;
}
